...
namespace db_assign
{
    public partial class driverForm : Form
    {
        ...
        private void sebmit_Click(object sender, EventArgs e)
        {
            ...
            string sql = "INSERT INTO driver (name, email, phone, pass, licenseNo, carColor, model, type, capacity) VALUES (@name, @email, @phone, @password, @license, @color, @model, @type, @capacity)";
